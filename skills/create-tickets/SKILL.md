...
nav:
  bay: plan
  when: "Create Jira tickets (epics, stories, spikes) with AC quality gate and local scaffolding."
  when_not: "Scaffolding AC for existing empty ticket (use /leo-ac-scaffold)."
  personas: [leo]
---
