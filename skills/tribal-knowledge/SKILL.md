...
nav:
  bay: know
  when: "Structured retrieval across all knowledge layers: ADRs, contracts, specs, memory, code."
  when_not: "Wiki health check (use /wiki-lint). Bibliotheque curation (use /bibliotheque-librarian)."
---
