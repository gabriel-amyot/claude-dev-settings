...
3. **Extract, don't inline.** If a block of instructions exceeds ~5 lines and serves a single concern, move it to `~/.claude/library/context/{topic}.md` and add a trigger row to the On-Demand Context table instead.
