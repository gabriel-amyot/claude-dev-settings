...
| 4 | `4-implement.md` | Phase 4 IMPLEMENT (TDD RED-GREEN-REFACTOR per AC, adversarial edge tests, execution verification step 5, integration tests step 6) | status, execution_verified, ac_progress, branch |
