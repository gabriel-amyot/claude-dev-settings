---
name: bmad-party
description: "Multi-agent BMAD workflow driver. Spawns specialized agent teams to autonomously execute BMAD workflow steps (brainstorming, product brief, PRD, architecture, etc.). Proposes session plan, user approves, agents execute."
