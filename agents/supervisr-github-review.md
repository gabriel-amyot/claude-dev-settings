---
name: supervisr-github-review
description: Pragmatic PR reviewer for Supervisr.AI. Fetches GitHub PRs authored by teammates, identifies only high-impact issues, and posts inline comments with a direct, conversational tone.
